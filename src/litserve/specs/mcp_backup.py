...
# MCP Primitive Types (using camelCase for protocol compliance)
class MCPTool(BaseModel):
    """MCP Tool definition following the protocol specification."""

    name: str
    description: Optional[str] = None
    input_schema: Optional[Dict[str, Any]] = None  # Will be serialized as inputSchema

    class Config:
        # Allow both camelCase (for protocol) and snake_case (for Python)
...
class MCPResource(BaseModel):
    ...
    description: Optional[str] = None
    mime_type: Optional[str] = None  # Will be serialized as mimeType
...
# MCP Request/Response Types (using camelCase for protocol compliance)
class InitializeRequest(BaseModel):
    """MCP Initialize request following the protocol specification."""

    protocol_version: str = "2024-11-05"  # Will be serialized as protocolVersion
    capabilities: Dict[str, Any]
    client_info: Dict[str, str]  # Will be serialized as clientInfo
...
class InitializeResponse(BaseModel):
    ...
    protocol_version: str = "2024-11-05"  # Will be serialized as protocolVersion
    capabilities: Dict[str, Any]
    server_info: Dict[str, str]  # Will be serialized as serverInfo
